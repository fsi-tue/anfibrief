\ifbachelor
	...
	\begin{itemize}
		...
		\iflehramt
			Mathematik-Studenten im Zweitfach brauchen Mathematik 1 nicht besuchen, da dieses Modul durch Analysis 1 abgedeckt wird. 
...
\begin{itemize}
	\item \textbf{\hypertarget{alma}{alma}} \url{https://alma.uni-tuebingen.de}\footnote{Bei Bedarf findest du hier eine Anleitung: \url{https://uni-tuebingen.de/einrichtungen/zentrum-fuer-datenverarbeitung/dienstleistungen/server/alma-portal/anleitungen-alma/\#c1016196}} \\
