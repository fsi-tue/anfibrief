...
\else
	% Mathe-Vorkurs
    \item[Mathevorkurs Bachelor -- \mathedatum~\YEAR]~\\
    \ifbachelor
...
% Kneipentour
\ifml
\item[Pub Crawl -- Wednesday, October 19th \YEAR, 18:00, \footnotesize{location \& start time will be given to you after registration}]~\\
...
\else
\item[Kneipentour -- Mittwoch, 19. Oktober \YEAR, 18 Uhr, \footnotesize{Ort \& Zeit wird dir nach Anmeldung mitgeteilt}]~\\
