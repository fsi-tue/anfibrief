...
\ifml
	\item[Board Game Night 1 -- Wednesday, October 4th, \YEAR, Sand]~\\%, 19:00, Sand]~\\
...
\else
    \item[Spieleabend 1 -- Mittwoch, 4. Oktober \YEAR, Sand]~\\%, 19:00 Uhr, Sand]~\\
...
\ifml
	\item[fsi trial meeting -- TBA]~\\%Thursday, May 18th \YEAR, 18:30, Sand]~\\
	...
	\seticon{faBus}~\textbf{bus stop:} Sand Drosselweg (bus lines 2 \& 6)
\else
	\item[Schnuppersitzung der fsi -- TBA]~\\%Donnerstag, 18. Mai \YEAR, 18:30 Uhr, Sand]~\\
