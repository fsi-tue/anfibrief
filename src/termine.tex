...
\ifkogwiss
    \ifmaster
      ...
      Informationen wann der Vorkurs stattfindet und wie ihr euch dazu anmelden könnt, findet ihr hier \url{https://www.fs-kogni.uni-tuebingen.de/}.
...
\else
	...
	oder \\
	\seticon{faBus}~\textbf{Bushaltestelle:} Linie 2, Linie 6 "`BG Unfallklinik"' (Rest ausgeschildert)
    \fi
\fi
...
%Spieleabend
\ifml
	\item[Friday, 22. October \YEAR, \footnotesize{location \& start time will be given to you after registration} ]\ \\
...
\else
    \item[Freitag, 22. Oktober \YEAR, \footnotesize{Ort \& Startzeit wird dir nach Anmeldung mitgeteilt}]\ \\
