...
\ifmaster
    \ifbinfo
        \item[TBA \YEAR, TBA, (Sand)]\ \\
            %Heute beginnt ein Informatik-Vorkurs speziell für Bioinformatik-Studenten im Master. Dieser Vorkurs wird dringend empfohlen, wenn du aus einem fachfremden Studiengang wie z.B. Biologie oder anderen Lebenswissenschaften kommst und noch keine oder sehr wenig Erfahrung in der Informatik und der Programmierung (CLI, Java, Python, \LaTeX) hast. Der Vorkurs wird in Englisch gehalten. Anmeldeschluss ist bis zum 20. Oktober, 12 Uhr. Alle weitere Informationen und die Anmeldung findest du auf folgender Website: \\
            Normalerweise findet ein Informatik-Vorkurs speziell für Bioinformatik-Studentn im Master statt. Dieser Vorkurs wird dringend empfohlen, wenn du aus einem fachfremden Studiengang wie z.B. Biologie oder anderen Lebenswissenschaften kommst und noch keine oder sehr wenig Erfahrung in der Informatik und der Programmierung (CLI, Java, Python, \LaTeX) hast. Der Vorkurs wird in Englisch gehalten. Falls dieser auch dieses Semester stattfindet, findest du nähere Infos auf folgender Webseite:\\
...
\else
	 \item[TBA \YEAR, \textasciitilde TBA, \footnotesize{Ort \& Startzeit wird dir nach Anmeldung mitgeteilt}]\ \\
...
\else
    \item[TBA \YEAR, TBA, \footnotesize{Ort \& Startzeit wird dir nach Anmeldung mitgeteilt}]\ \\
        Diese Veranstaltung findet nur statt, falls es die Corona-Maßnahmen zulassen! Updates und Anmeldungen dazu, findet ihr auf \url{https://www.fsi.uni-tuebingen.de/ersti/}.
...
\else
	%\item[Freitag, 30. Oktober \YEAR, \textasciitilde 19 Uhr, \footnotesize{Ort \& Startzeit wird dir nach Anmeldung mitgeteilt}]\ \\
...
\ifml
	...
	%The Tübingen Treasure Hunt allows you to get a first impression of your university town without actually being there (yet). The treasure hunt is a mixture of city tour and escape room, so expect riddles and tasks along the way, which also offer the opportunity to get to know your fellow students better. 
\else
    \item[TBA \YEAR, TBA, online]\ \\
...
\ifbachelor
    \iflehramt
        \item[Dienstag, 20. April \YEAR, online]\ \\
            ...
            Weitere Details findest du auf \url{https://alma.uni-tuebingen.de/alma/pages/cm/exa/coursecatalog/showCourseCatalog.xhtml?_flowId=showCourseCatalog-flow&_flowExecutionKey=e1s1}
    ...
    \else
        \item[Montag, 19. April \YEAR, 10 Uhr, online]\ \\
            ...
            Die Details findest du auf \url{https://alma.uni-tuebingen.de/alma/pages/cm/exa/coursecatalog/showCourseCatalog.xhtml?_flowId=showCourseCatalog-flow&_flowExecutionKey=e1s1}
            Alles, was du heute (und in Zukunft) benötigst: persönlichen Wachmacher, einen Stift und einen Block. %und den Studierendenausweis.
...
\else
    \item[Freitag, 16. April \YEAR, 19 Uhr, online]\ \\
        Heute findet der speziell für Corona-Bedingungen eingeführte Online-Spieleabend der Fachschaft statt. Hier kommst du auf Discord mit deinen Kommilitonen zusammen und spielst Fever.io, Drawful2.io und mehr! Die Anmeldung findest du auf \url{https://www.fsi.uni-tuebingen.de/ersti/}.\\
        Der Link zum Discrod wird dir nach der Anmeldung rechtzeitig per E-Mail zugeschickt.
\fi
