...
\else
    \item[Montag, 30. März \YEAR]\ \\
  Heute beginnt der Vorbereitungskurs Mathematik. Es ist nicht Pflicht daran teilzunehmen,
	es ist aber sehr empfehlenswert. Aufgrund der aktuellen Lage findet der Vorkurs online statt.
	...
	\fi
    Um am Vorkurs teilzunehmen, musst du dich bis zum 26. März \YEAR~anmelden. Falls der Brief aus unerfindlichen Gründen erst nach dem 26. März bei dir eintrifft oder du sonstige Fragen dazu hast, melde dich bitte bei Dr. Britta Dorn \texttt{britta.dorn@uni-tuebingen.de}\\
...
\ifbachelor
    \iflehramt
        \item[Dienstag, 21. April \YEAR, Morgenstelle]\ \\
    ...
    \else
        \item[Montag, 20. April \YEAR, Morgenstelle]\ \\
            Deine erste Vorlesung beginnt (voraussichtlich)... \\
            Du hast um 10 Uhr „Mathematik II“ bei Prof. Kaufmann.
            Alles, was du heute (und in Zukunft) benötigst: persönlichen Wachmacher, einen Stift, einen Block und den Studierendenausweis.
...
\else
	 \item[Dienstag, 28. April \YEAR, 18:00 Uhr, \textbf{vor} dem Neckarmüller ]\ \\
