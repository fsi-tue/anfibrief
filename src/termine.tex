\setlength{\fboxrule}{4pt}
	\fcolorbox{red}{white}{
		\begin{minipage}[t]{
				\textwidth}\textbf{Achtung!} Aufgrund der aktuellen Lage bezüglich COVID-19 werden sich die Anfi-Termine für dieses Semester noch ändern. Wir sind im ständigen Austausch mit dem Fachbereich und der Universitätsleitung und müssen den weiteren Verlauf von Verboten und Richtlinien abwarten. Schaut \textbf{auf jeden Fall} immer wieder auf \url{https://www.fsi.uni-tuebingen.de/ersti} nach,
dort werden wir die aktuellsten Daten veröffentlichen, sobald wir mehr wissen.
		\end{minipage}}
\begin{description}
...
\ifbachelor
    \iflehramt
        \item[Dienstag, 2. November \YEAR, TBA]\ \\
            Deine erste Vorlesung beginnt (voraussichtlich)... \\
            Du hast um 14 Uhr „Informatik II“ bei \Infoprof.
    ...
    \else
        \item[Montag, 20. April \YEAR, TBA]\ \\
            Deine erste Vorlesung beginnt (voraussichtlich)... \\
            Du hast um 10 Uhr „Mathematik I“ bei [........].
            Alles, was du heute (und in Zukunft) benötigst: persönlichen Wachmacher, einen Stift, einen Block und den Studierendenausweis.
...
%TODO Text Wanderung
\item[Samstag, 24. Oktober, \YEAR TBA, TBA]\ \\
        Heute findet eine Wanderung zum .... statt. Bitte meldet euch zu diesem Termin an, da wir wegen der Corona-Maßnahmen eine nur eine begrenzte Teilnehmeranzahl haben, und so mehr Gruppen organisieren können, damit mehr Leute an diesem Erlebnis teilnehmen können.\\
\item[Donnerstag, 8. November, \YEAR TBA, TBA]\ \\
        Heute findet voraussichtlich die zweite Wanderung statt. Bitte meldet euch zu diesem Termin an, da wir wegen der Corona-Maßnahmen eine nur eine begrenzte Teilnehmeranzahl haben, und so mehr Gruppen organisieren können, damit mehr Leute an diesem Erlebnis teilnehmen können.\\
...
%Clubhausfest
\ifml
    \item[Thursday, October 14th, \YEAR, 18:00, Clubhaus]\ \\
...
\else
    \item[Donnerstag, 14. Oktober \YEAR, 21:00 Uhr, Clubhaus ]\ \\
