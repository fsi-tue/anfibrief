...
%Grillen 1
\ifml
    \item[BBQ 1 -- Saturday, October 5th \YEAR, 18:30, in the garden of the Sand]~\\
    ...
    \seticon{faBus}~\textbf{bus stop:} Sand Drosselweg (bus lines 2 \& 6)
\else
    \item[Grillen 1 -- Samstag, 5. Oktober \YEAR, 18:30 Uhr, im Garten des Sandes]~\\
...
% % Frühstück % TODO Uhrzeit & findet es statt?
% \ifbachelor
...
% Kastenlauf
\ifml
\item[Crate Run -- TBA]~\\ %Friday, April 14th \YEAR, 18:00, Rewe West]~\\
...
\else
\item[Kastenlauf -- TBA]~\\ %Freitag, 14. April \YEAR, 18:00 Uhr, Rewe Weststadt]~\\
...
%Grillen 2
\ifml
    \item[BBQ 1 -- Saturday, October 19th \YEAR, 18:30, in the garden of the Sand]~\\
    ...
    \seticon{faBus}~\textbf{bus stop:} Sand Drosselweg (bus lines 2 \& 6)
\else
    \item[Grillen 1 -- Samstag, 19. Oktober \YEAR, 18:30 Uhr, im Garten des Sandes]~\\
...
%Wanderung 2 %TODO location
\ifml
    \item[Hike 2 -- Friday, October 25th \YEAR, 10:30]~\\%, on the Neckarinsel (Neckar Island)]~\\
    ...
    \seticon{faBus}~\textbf{bus stop:} Neckarbrücke (lines 1--22)
\else
    \item[Wanderung 2 -- Freitag, 25. Oktober \YEAR, 10:30 Uhr]~\\%, auf der Neckarinsel]~\\
    Zeit für eine weitere Wanderung! Komm mit auf einen entspannten Spaziergang durch die schöne Umgebung Tübingens.
    Bei einer gemütlichen Wanderung lernt ihr euren Kommilitonen und Kommilitoninnen
