...
\ifbachelor
    \iflehramt
        \item[Dienstag, 20. April \YEAR, online]\ \\
            ...
            Weitere Details findest du auf \url{https://alma.uni-tuebingen.de/alma/pages/startFlow.xhtml?_flowId=detailView-flow&_flowExecutionKey=e3s1}\\
    ...
    \else
        \item[Montag, 19. April \YEAR, 10 Uhr, online]\ \\
            ...
            Die Details findest du auf \url{https://alma.uni-tuebingen.de/alma/pages/startFlow.xhtml?_flowId=detailView-flow&_flowExecutionKey=e4s1}\\
            Alles, was du heute (und in Zukunft) benötigst: persönlichen Wachmacher, einen Stift und einen Block. %und den Studierendenausweis.
