	...
	\fcolorbox{red}{white}{
		\begin{minipage}[t]{\textwidth}
			\ifml
				...
				Further details on the respective event and the registration can always be found on \url{https://www.fsi.uni-tuebingen.de/du-bist-ersti}.
			...
			\else
				...
				Weitere Details und die Anmeldung zur jeweiligen Veranstaltung  findest du auch immer auf \url{https://www.fsi.uni-tuebingen.de/du-bist-ersti}.
			\fi
		\end{minipage}}
\begin{description}
...
\else
	\item[Kastenlauf -- Freitag, 7. Oktober \YEAR, Sand]~\\ %todo: Datum, Uhrzeit?
...
\else
	\item[Kneipentour -- Dienstag, 11. April \YEAR]~\\%, ca. 18 Uhr]~\\
...
\else
	\item[Stadtrallye -- Mittwoch, 12. April \YEAR, ca. 16 Uhr]~\\ %todo: Uhrzeit?
...
% Erste Vorlesung
\ifbachelor
	\item[Erste Vorlesung -- Montag, 17. April \YEAR, 10:00, Morgenstelle]~\\ %TODO: Uhrzeit anpassen
	Deine erste Vorlesung beginnt um
	\ifwintersemester 8 Uhr -- Du hast „Mathematik für Informatik 1“  \fi
	\ifsommersemester 10 Uhr -- Du hast „Mathematik für Informatik 2“  \fi
	bei \Matheprof.
...
%Spieleabend 2
\ifml
	\item[Board Game Night 2 -- Wednesday, May 3th, \YEAR, 19:00, Sand]~\\
	...
	\seticon{faBus}~\textbf{bus stop:} Sand Drosselweg (bus lines 2 \& 6)
\else
	\item[Spieleabend 2 -- Mittwoch, 3. Mai \YEAR, 19 Uhr, Sand]~\\ %todo: Datum, Uhrzeit?
