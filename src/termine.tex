...
\else
	\vspace{-2.07182\baselineskip} \ \\ % to counteract the different spacing of the parbox in the line below. Remove this line if you remove the parbox and vspace in the line below
	\item[\parbox{\linewidth}{Semestereröffnung Fachbereich -- Donnerstag, 10. Oktober \YEAR, 16:15, Audimax, Neue Aula}]\ \vspace{.355\baselineskip} \\ % parbox and vspace since the line is too long
